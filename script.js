...
const pilihan = document.querySelector ("footer1 buttonf");
const guide = document.querySelector(".guide");
const lanjut = document.querySelector("footer5 button5");
//jika klik pilihan
pilihan.onclick = ()=>{
   option_box.classList.add("activeOption");
   quiz_box.classList.remove("activeQuiz");
}
//jika klik selanjutnya 
lanjut.onclick = () =>{
   quiz_box.classList.add("activeQuiz");
   lanjut.classList.remove("activeButton5");
   guide.classList.remove("activeGuide");
}
//jika click mulaijawab
start_btn.onclick = ()=>{
   guide.classList.add("activeGuide");
   button3.classList.remove("activeButton3");
}
//jika klik pembahasan
next_btn.onclick = ()=>{
   option_box.classList.remove("activeOption");
